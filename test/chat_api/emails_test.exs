  ...
  describe "emails" do
    ...
    test "new_message_alert/2 generates a new message alert for a message from an anonymous customer",
      ...
      assert email.html_body ==
               "New message from an anonymous user:<br /><b>some message body</b><br /><br /><a href=\"https://app.Hakerspeak.io/conversations/#{
                 conversation_id
               }\">View in dashboard</a>"
    end
    ...
    test "new_message_alert/2 generates a new message alert for a message from a customer with a name",
      ...
      assert email.html_body ==
               "New message from Test User:<br /><b>some message body</b><br /><br /><a href=\"https://app.Hakerspeak.io/conversations/#{
                 conversation_id
               }\">View in dashboard</a>"
    end
    ...
    test "new_message_alert/2 generates a new message alert for a message from a customer with an email",
      ...
      assert email.html_body ==
               "New message from customer@customer.com:<br /><b>some message body</b><br /><br /><a href=\"https://app.Hakerspeak.io/conversations/#{
                 conversation_id
               }\">View in dashboard</a>"
    end
    ...
    test "new_message_alert/2 generates a new message alert for a message from a customer with both a name and an email",
      ...
      assert email.html_body ==
               "New message from Test User (customer@customer.com):<br /><b>some message body</b><br /><br /><a href=\"https://app.Hakerspeak.io/conversations/#{
                 conversation_id
               }\">View in dashboard</a>"
    end
  end
